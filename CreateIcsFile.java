...
public class CreateIcsFile {
    ...
    private static void commonHoliday(Integer year, List<Holiday> list) {
        ...
        Integer int0501 = Integer.parseInt(year + "0501"); // 2026년 이후
        ...
        if (year >= 2026) {
            ...
            // 2026년부터 노동절 대체공휴일 지정
            LocalDate holiday0501 = substituteHoliday(int0501);
            if (holiday0501 != null) {
                addHoliday(list, toInteger(holiday0501), "대체공휴일(노동절)");
            }
        }
    }
    ...
    private static List<Holiday> setHoliday() {
        ...
        addHoliday(list, 20250603, "제21대 대통령 선거");
